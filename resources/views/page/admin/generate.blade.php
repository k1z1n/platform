...
@section('content')
    <div>
        <form class="max-w-sm mx-auto bg-white p-5 rounded-lg shadow-md" method="post"
            ...
            <button type="submit"
                    class="text-white bg-gra focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Генерация
            </button>
        </form>
    </div>
