                ...
                <div class="flex gap-5">
                    <form class="max-w-lg mb-5" method="GET" action="{{ route('admin.list') }}">
                        <div class="flex">
                            ...
                            <button id="dropdown-button" data-dropdown-toggle="dropdown" class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-s-lg hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white dark:border-gray-600" type="button">
                            ...
                            <!-- Dropdown Menu -->
                            <div id="dropdown" class="z-10 hidden left-28 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
                                    <li>
                                        <button type="button" class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onclick="setCategory('')">Все группы</button>
                                    </li>
                            ...
                            <div class="relative w-52">
                                <input type="search" id="search-dropdown" name="search" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 dark:bg-gray-700 dark:border-s-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Поиск студента..." value="{{ request('search') }}" />
                                <button type="submit" class=" bg-gra absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white rounded-e-lg hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700">
                    ...
                    <a href="{{ route('admin.list') }}" class="p-[11px] text-sm text-white font-medium h-full bg-gray-800 rounded-lg dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600">
                        Сбросить
                    </a>
